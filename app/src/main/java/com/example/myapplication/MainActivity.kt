...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMain.fab.setOnClickListener { view ->
            Snackbar.make(
                view,
                "Un problème n'hésiter pas à contacter l'équipe Ephec Food",
                Snackbar.LENGTH_LONG
            )
            Snackbar.make(
                view,
                "Problème avec l'application , contacter le service : ephecfood@students.ephec.be",
                Snackbar.LENGTH_LONG
            )
        ...
        button_sign.setOnClickListener {
            ...
            val editTextPassword =
                findViewById<EditText>(R.id.text_input_password_toggle).text.toString()
            ...
            Toast.makeText(
                this,
                "La connexion est accepté pour l'email" + editTextEmail,
                Toast.LENGTH_LONG
            ).show();
